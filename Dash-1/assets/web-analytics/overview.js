  ...
  var dataPoints = [];
	...
	function addData(data) {
 		for (var i = 0; i < data.length; i++) {
			   var col = date_diff( '11/15/2018', data[i].rdate);
				 console.log(col);
				  if(col > 90){
							coloring.push("red")
					}
	...
	CanvasJS.addColorSet("greenShades",coloring);

	var ageBarChart = new CanvasJS.Chart("BarChart", {
...
window.setTimeout(renderBarChart, 500);
		...
		data: [
			{
				...
				type: "pie",
				dataPoints: [
					{ y: 342373.50, name:"Keyboards", color: "#393f63" },
					{ y: 348421.50, name:"bags", color: "#e5d8b0" },
					{ y: 553455.00, name:"Gadgets", color: "#ffb367" },
					{ y: 230391.00, name:"Laptop", color: "#f98461" },
